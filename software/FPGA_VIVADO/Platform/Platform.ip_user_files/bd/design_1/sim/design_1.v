...
module design_1
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLKIN CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLKIN, CLK_DOMAIN design_1_clkin, FREQ_HZ 10000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input clkin;
  ...
  assign LED_D10[0] = v_axi4s_vid_out_0_overflow;
  assign LED_D11[0] = v_axi4s_vid_out_0_underflow;
  assign LED_D12[0] = v_axi4s_vid_out_0_locked;
  assign LED_D9[0] = xlslice_0_Dout;
  ...
  design_1_axi_dynclk_0_0 axi_dynclk_0
       (.LOCKED_O(axi_dynclk_0_LOCKED_O),
        ...
        .REF_CLK_I(processing_system7_0_FCLK_CLK3),
        .s_axi_lite_aclk(processing_system7_0_FCLK_CLK3),
        .s_axi_lite_araddr(smartconnect_1_M01_AXI_ARADDR),
        .s_axi_lite_aresetn(proc_sys_reset_3_peripheral_reset),
        .s_axi_lite_arprot(smartconnect_1_M01_AXI_ARPROT),
        ...
        .s_axi_lite_awprot(smartconnect_1_M01_AXI_AWPROT),
        ...
        .s_axi_lite_wstrb(smartconnect_1_M01_AXI_WSTRB),
        .s_axi_lite_wvalid(smartconnect_1_M01_AXI_WVALID));
  design_1_axi_vdma_0_0 axi_vdma_0
       (.axi_resetn(proc_sys_reset_3_peripheral_reset),
        ...
        .m_axis_mm2s_aclk(processing_system7_0_FCLK_CLK3),
  ...
  design_1_proc_sys_reset_0_3 proc_sys_reset_3
       (.aux_reset_in(1'b1),
        ...
        .mb_debug_sys_rst(1'b0),
        .peripheral_aresetn(proc_sys_reset_3_peripheral_reset),
  ...
  design_1_processing_system7_0_0 processing_system7_0
       (.CAN0_PHY_RX(1'b0),
        ...
        .DDR_WEB(DDR_we_n),
        .DMA0_ACLK(processing_system7_0_FCLK_CLK3),
        .DMA0_DAREADY(1'b1),
        .DMA0_DRLAST(1'b0),
        ...
        .S_AXI_GP0_ACLK(processing_system7_0_FCLK_CLK3),
        ...
        .S_AXI_GP1_ACLK(processing_system7_0_FCLK_CLK3),
        ...
        .S_AXI_GP1_ARBURST({1'b0,1'b1}),
        .S_AXI_GP1_ARCACHE({1'b0,1'b0,1'b1,1'b1}),
        ...
        .S_AXI_GP1_ARSIZE({1'b0,1'b1,1'b0}),
  ...
  design_1_rgb2dvi_0_0 rgb2dvi_0
       (.PixelClk(axi_dynclk_0_PXL_CLK_O),
        ...
        .vid_pData(v_axi4s_vid_out_0_vid_io_out_DATA[23:0]),
  ...
  design_1_smartconnect_0_0 smartconnect_0
       (.M00_AXI_araddr(smartconnect_0_M00_AXI_ARADDR),
        ...
        .aresetn(proc_sys_reset_3_peripheral_reset));
  ...
  design_1_v_axi4s_vid_out_0_0 v_axi4s_vid_out_0
       (.aclk(processing_system7_0_FCLK_CLK3),
        ...
        .vtg_field_id(v_tc_0_vtiming_out_FIELD),
  ...
  design_1_v_tc_0_0 v_tc_0
       (.active_video_out(v_tc_0_vtiming_out_ACTIVE_VIDEO),
        ...
        .clken(1'b1),
        .field_id_out(v_tc_0_vtiming_out_FIELD),
        .fsync_in(1'b0),
        ...
        .s_axi_aresetn(proc_sys_reset_3_peripheral_reset),
