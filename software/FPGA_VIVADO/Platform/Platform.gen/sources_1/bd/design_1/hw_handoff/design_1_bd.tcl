...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set LED_D9 [ create_bd_port -dir O -from 0 -to 0 LED_D9 ]
  set LED_D10 [ create_bd_port -dir O -from 0 -to 0 LED_D10 ]
  set LED_D11 [ create_bd_port -dir O -from 0 -to 0 LED_D11 ]
  set LED_D12 [ create_bd_port -dir O -from 0 -to 0 LED_D12 ]
  set clkin [ create_bd_port -dir I -type clk -freq_hz 10000000 clkin ]
  ...
  set_property -dict [ list \
   CONFIG.Final_Count_Value {FFFFE} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_FPGA3_PERIPHERAL_FREQMHZ {153.846161} \
   ...
   CONFIG.PCW_CLK3_FREQ {153846161} \
   ...
   CONFIG.PCW_FCLK0_PERIPHERAL_DIVISOR0 {50} \
   CONFIG.PCW_FCLK0_PERIPHERAL_DIVISOR1 {40} \
   ...
   CONFIG.PCW_MIO_TREE_PERIPHERALS {GPIO#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#GPIO#Quad SPI Flash#Quad SPI\
Flash#GPIO#GPIO#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#Enet 0#Enet 0#Enet 0#Enet\
0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#USB 0#USB 0#USB 0#USB\
0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD\
0#SD 0#USB Reset#UART 1#UART 1#I2C 0#I2C 0#Enet 0#Enet 0}\
   CONFIG.PCW_MIO_TREE_SIGNALS {gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#gpio[4]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#gpio[8]#sdio1_pow#data[0]#cmd#clk#data[1]#data[2]#data[3]#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#cd#reset#tx#rx#scl#sda#mdc#mdio}\
   ...
   CONFIG.PCW_PJTAG_PJTAG_IO {EMIO} \
   ...
   CONFIG.PCW_SD1_GRP_POW_IO {MIO 9} \
  ...
  connect_bd_intf_net -intf_net smartconnect_1_M00_AXI [get_bd_intf_pins axi_vdma_0/S_AXI_LITE] [get_bd_intf_pins smartconnect_1/M00_AXI]
  connect_bd_intf_net -intf_net smartconnect_1_M01_AXI [get_bd_intf_pins axi_dynclk_0/S_AXI_LITE] [get_bd_intf_pins smartconnect_1/M01_AXI]
  connect_bd_intf_net -intf_net smartconnect_1_M02_AXI [get_bd_intf_pins smartconnect_1/M02_AXI] [get_bd_intf_pins v_tc_0/ctrl]
  ...
  connect_bd_net -net axi_dynclk_0_LOCKED_O [get_bd_pins axi_dynclk_0/LOCKED_O] [get_bd_pins rgb2dvi_0/aRst_n] [get_bd_pins v_axi4s_vid_out_0/aresetn]
  ...
  connect_bd_net -net proc_sys_reset_1_interconnect_aresetn [get_bd_pins proc_sys_reset_3/interconnect_aresetn] [get_bd_pins smartconnect_1/aresetn]
  connect_bd_net -net proc_sys_reset_3_peripheral_reset [get_bd_pins axi_dynclk_0/s_axi_lite_aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins proc_sys_reset_3/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins v_tc_0/s_axi_aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK3 [get_bd_pins axi_dynclk_0/REF_CLK_I] [get_bd_pins axi_dynclk_0/s_axi_lite_aclk] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins proc_sys_reset_3/slowest_sync_clk] [get_bd_pins processing_system7_0/DMA0_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK3] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/M_AXI_GP1_ACLK] [get_bd_pins processing_system7_0/S_AXI_ACP_ACLK] [get_bd_pins processing_system7_0/S_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_GP1_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP1_ACLK] [get_bd_pins smartconnect_0/aclk] [get_bd_pins smartconnect_1/aclk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins v_tc_0/s_axi_aclk]
  ...
  connect_bd_net -net v_axi4s_vid_out_0_locked [get_bd_ports LED_D12] [get_bd_pins v_axi4s_vid_out_0/locked]
  connect_bd_net -net v_axi4s_vid_out_0_overflow [get_bd_ports LED_D10] [get_bd_pins v_axi4s_vid_out_0/overflow]
  ...
  connect_bd_net -net v_axi4s_vid_out_0_underflow [get_bd_ports LED_D11] [get_bd_pins v_axi4s_vid_out_0/underflow]
  connect_bd_net -net v_axi4s_vid_out_0_vtg_ce [get_bd_pins v_axi4s_vid_out_0/vtg_ce] [get_bd_pins v_tc_0/gen_clken]
  connect_bd_net -net v_tc_0_irq [get_bd_pins v_tc_0/irq] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlslice_0_Dout [get_bd_ports LED_D9] [get_bd_pins xlslice_0/Dout]
  ...
  set_property PFM_NAME {IND1R:A9ZynqTest:Platform:1.3} [get_files [current_bd_design].bd]
  set_property PFM.CLOCK {FCLK_CLK0 {id "0" is_default "false" proc_sys_reset "proc_sys_reset_0" status "fixed" freq_hz "50000000"} FCLK_CLK1 {id "1" is_default "false" proc_sys_reset "proc_sys_reset_1" status "fixed" freq_hz "125000000"} FCLK_CLK2 {id "2" is_default "false" proc_sys_reset "proc_sys_reset_2" status "fixed" freq_hz "200000000"} FCLK_CLK3 {id "3" is_default "true" proc_sys_reset "proc_sys_reset_3" status "fixed" freq_hz "250000000"}} [get_bd_cells /processing_system7_0]
  set_property PFM.AXI_PORT {S01_AXI {memport "S_AXI_HP" sptag "" memory "" is_range "true"} M01_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "true"}} [get_bd_cells /smartconnect_0]
