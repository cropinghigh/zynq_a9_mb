...
proc create_hier_cell_s00_entry_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.MSC000_ROUTE {0b10000000011} \
   CONFIG.MSC001_ROUTE {0b10000000101} \
   CONFIG.MSC002_ROUTE {0b10000001001} \
   CONFIG.MSC003_ROUTE {0b10000010001} \
   CONFIG.MSC004_ROUTE {0b10000100001} \
   CONFIG.MSC005_ROUTE {0b10001000001} \
   CONFIG.MSC006_ROUTE {0b10010000001} \
   CONFIG.MSC007_ROUTE {0b10100000001} \
   CONFIG.MSC008_ROUTE {0b11000000001} \
   CONFIG.MSC_ROUTE_WIDTH {11} \
   CONFIG.NUM_MSC {9} \
   ...
   CONFIG.SEG000_BASE_ADDR {0x0000000043000000} \
   ...
   CONFIG.SEG001_BASE_ADDR {0x0000000043C00000} \
   ...
   CONFIG.SEG002_BASE_ADDR {0x0000000043C10000} \
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {M00_AXI:M01_AXI:M02_AXI:M03_AXI:M04_AXI:M05_AXI:M06_AXI:M07_AXI:M08_AXI:S00_AXI} \
 ] $aclk
