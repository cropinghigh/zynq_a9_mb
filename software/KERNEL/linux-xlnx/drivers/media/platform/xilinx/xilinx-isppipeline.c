...
static u16 xisp_compute_data_reliability_weight(u32 c_intersec, u32 mu_h, u32 mu_l, u32 r)
{
	...
	if (r < mu_l) {
		...
		u64 xpow = div64_u64((c_intersec * x), XISP_1M);
		...
		u64 taylor_coeff_1 = div64_u64(xpow, XISP_1K);
		u64 int_coeff_21 = div64_u64(int_pow(xpow, 2), (XISP_1H * XISP_1K));
		u64 taylor_coeff_2 = div64_u64(int_coeff_21, (20 * XISP_1K));
		u64 int_coeff_31 = div64_u64(xpow, (6 * XISP_1K));
		u64 taylor_coeff_3 = div64_u64((int_coeff_21 * int_coeff_31), (10 * XISP_1M));
		u64 taylor_coeff_4 = div64_u64((int_coeff_21 * int_coeff_21), (24 * XISP_1H_1B));
		u64 int_coeff_51 = div64_u64((int_coeff_21 * xpow), (120 * XISP_1M));
		u64 taylor_coeff_5 = div64_u64((int_coeff_21 * int_coeff_51), XISP_1H_1B);
		u64 int_coeff_61 = div64_u64((int_coeff_21 * int_coeff_21), (72 * XISP_1M));
		u64 taylor_coeff_6 = div64_u64((int_coeff_61 * int_coeff_21), (10 * XISP_1T));
		u64 int_coeff_71 = div64_u64((int_coeff_21 * xpow), 5040);
		...
		u64 taylor_coeff_8 = div64_u64((int_coeff_81 * int_coeff_82), XISP_CONST1);
		u64 int_coeff_91 = div64_u64((int_coeff_21 * int_coeff_21), (XISP_1H * XISP_1M));
		u64 int_coeff_92 = div64_u64((int_coeff_21 * xpow), (XISP_1H * XISP_1K));
		...
		u64 int_coeff_103 = div64_u64(int_coeff_21, (XISP_1H * XISP_1K));
		...
		u64 int_coeff_122 = div64_u64((int_coeff_121 * int_coeff_21), 479001600);
		u64 int_coeff_123 = div64_u64((int_coeff_122 * int_coeff_21), XISP_1M);
		...
		u64 int_coeff_132 = div64_u64((int_coeff_131 * int_coeff_112 * int_coeff_21),
				    XISP_1T);
		u64 int_coeff_133 = div64_u64((int_coeff_132 * int_coeff_21), XISP_1M);
		u64 taylor_coeff_13 = div64_u64((int_coeff_133 * int_coeff_21), XISP_CONST5);
		u64 int_coeff_141 = div64_u64((int_coeff_131 * int_coeff_21), (XISP_1H * XISP_1K));
		u64 int_coeff_142 = div64_u64((int_coeff_131 * int_coeff_141), (XISP_1H * XISP_1K));
		u64 taylor_coeff_14 = div64_u64((int_coeff_131 * int_coeff_142), (87178291200 * XISP_1K));
		...
		wr = div64_u64((wr1 * XISP_WR_CV), XISP_1K);
	}
			   ...
			   u32 rho, u16 weights1[XISP_W_B_SIZE], u16 weights2[XISP_W_B_SIZE])
{
	...
	u32 value_max = div64_u64((XISP_MAX_INTENSITY - optical_black_value), alpha);
	u32 c_inters;
	int m = XISP_NO_EXPS;
	int i, j;

	for (i = 0; i < m - 1; i++) {
		gamma_out[i] = div64_u64((10 * (rho * (XISP_MAX_INTENSITY - optical_black_value)
				- optical_black_value * (div64_u64(XISP_MAX_INTENSITY, 10) - rho))),
				(exposure_time[i] * rho + exposure_time[i + 1] *
				(div64_u64(XISP_MAX_INTENSITY, 10) - rho)));
		if (!i) {
			u32 value = div64_u64((10 * rho - optical_black_value), alpha);

			mu_h[i] = div64_u64((100 * value), exposure_time[0]);
		} else {
